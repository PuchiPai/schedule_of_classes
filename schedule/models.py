...
# ==========================================================
# ЗОНА ОТВЕТСТВЕННОСТИ УЧАСТНИКА №2: РАСПИСАНИЕ
# ==========================================================
# Здесь будет модель ScheduleEntry.
# Требования:
# 1. room может быть NULL (для онлайн-занятий).
# 2. on_delete=models.PROTECT для связей.
# 3. Учет NULL в UniqueConstraint.
# 4. Валидация: не более 5 пар в день.
# ==========================================================